...
int main()
{
	...
	case 3:
		...
		cout << "	Пользователь должен отвечать на поставленные ему задачи(загадки) и за правильные ответы будет получать баллы. В викторине предусмотренна возможность использования подсказки 50/50. В случае неправильного ответа, у него будут отниматься жизни(Количество вопросов, жизней, подсказок можно изменить в настройках)." << endl;
